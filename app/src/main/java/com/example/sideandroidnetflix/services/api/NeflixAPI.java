package com.example.sideandroidnetflix.services.api;

import android.os.AsyncTask;

public class NeflixAPI extends AsyncTask<String> {
    public boolean setAuthentication(String id, String password)
    {
        boolean ret = true;
